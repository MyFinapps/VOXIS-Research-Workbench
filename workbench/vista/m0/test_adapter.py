    ...
    return {
        ...
        "representation_states": [
            ...
            },
            {
                ...
                "transform": {"translation": [0.18, 1.62, -2.1], "rotation_quaternion_xyzw": [0, 0, 0.3173047, 0.9483237], "scale": [0.83, 0.83, 0.83], "pivot": [0, 0, 0], "pivot_rule": "M0 center pivot", "native_transform": {"rotation_deg_xyz": [0,0,37]}},
            },
        ],
    }
